...
@section('title', 'Nueva Radiografía')  
...
<div class="container-fluid">
    ...
    <div class="custom-div-tesis-gradient shadow mb-4">
        <div>
            ...
            <div>
                <h1 class="h1 mb-1 text-white-800">Añadir Nueva Radiografía</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Formulario Radiografía</h6>
                </div>
                <div class="card-body">
                    {!!Form::open(['url'=>'radiografia/create', 'enctype' => 'multipart/form-data','method'=>'POST', 'files'=>'true'])!!}
                    {{ csrf_field() }}
                        ...
                        <div class="button-icon-tesis">
                            ...
                            <h5 class="button-icon-tesis-text">Agregar Radiografía</h5>
                        </div>
                    {{Form::Close()}}
                </div>
            </div>
